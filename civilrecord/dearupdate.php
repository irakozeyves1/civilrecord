...
<div style="width:800px; height:330px; background-color:#999900; margin:0px auto 0px auto"><center><h1 style="table-layout:auto; color:#663333;">DIED PEOPLE REPORT</h1></center>
<?php include('connection.php'); ?>

<body>
               <center> <form method="post" action="dearseach.php">
...
<div style=" max-height:200px; max-width:900px; overflow:scroll">
              ...
              <center>  <table cellpadding="2" cellspacing="2" border="2" bordercolor="#000000" class="table table-striped table-bordered" >
                    ...
                    <tbody>
                        <?php
                        $query = mysql_query("SELECT * FROM dear1") or die(mysql_error());
