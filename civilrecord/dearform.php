...
<div style="width:800px; height:315px; background-color:#999900; margin:0px auto 0px auto"><center><h1 style="table-layout:auto; color:#663333;">DIED PEOPLE REGISTRATION</h1></center><form action="dearsend.php" method="post">

<center><table>
<tr><td>First Name:</td><td><input type="text" name="name1"></td></tr>

<tr><td>Last Name:</td><td><input type="text"name="name2"></td></tr>
<tr><td>National Id:</td><td><input type="text"name="name3"></td></tr>
<tr><td>gender:</td><td><select name="name4">
    <option value="male">male</option>
    <option value="female">female</option>
  </select></td></tr>
  
<tr><td>Date of Dead:</td><td><input type="text"name="name5"></td></tr>

<tr><td>Father Names:</td><td><input type="text"name="name6"></td></tr>
<tr><td>Mather Names:</td><td><input type="text" name="name7"></td></tr>

<tr><td>Cellel:</td><td><input type="text"name="name8"></td></tr>
<tr><td>Vellage:</td><td><input type="text"name="name9"></td></tr>
